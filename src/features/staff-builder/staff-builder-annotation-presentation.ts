...
export const STAFF_BUILDER_ANNOTATION_KIND_LABELS = { "study-note": "Study Note", "practice-mark": "Practice Mark", bookmark: "Bookmark", "lyric-cue": "Lyric Cue" } as const;
export const STAFF_BUILDER_ANNOTATION_LAYER_LABELS: Readonly<Record<StaffBuilderAnnotationLayer, string>> = { "study-notes": "Study Notes", "practice-marks": "Practice Marks", bookmarks: "Bookmarks", "lyric-cues": "Lyric Cues" };
...
export function describeStaffBuilderAnnotation(annotation: StaffBuilderAnnotation): string {
  if (annotation.kind === "study-note" || annotation.kind === "lyric-cue") return annotation.text;
