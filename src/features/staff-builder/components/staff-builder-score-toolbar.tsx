...
export function StaffBuilderScoreToolbar({ score, measureIndex, navigationDisabled = false, navigationDisabledReason, onNavigate, playbackControls }: Readonly<{
  ...
  return <section aria-label="Score controls" className="staff-builder-score-toolbar">
    <div className="staff-builder-score-toolbar-row">
      ...
      <div className="staff-builder-score-toolbar-navigation"><StaffBuilderMeasureNavigation disabled={navigationDisabled} disabledReason={navigationDisabledReason} measureCount={score.measures.length} measureIndex={measureIndex} onNavigate={onNavigate} /></div>
