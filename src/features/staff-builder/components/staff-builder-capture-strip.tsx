...
export function StaffBuilderCaptureStrip({ captureState, hasPending, onStepDurationChange, onPrevious, onLock, onNext, onClear, showKeyboardLauncher = false, onOpenKeyboard, keyboardLauncherRef }: Readonly<{
