...
const baseScore = (measures: StaffBuilderScore["measures"], options: Partial<Pick<StaffBuilderScore, "initialTimeSignature" | "initialKeySignatureId" | "tempoBpm" | "ties">> = {}): StaffBuilderScore => ({ schemaVersion: 3, annotations: [], id: "score", title: "Study", createdAt: "2026-01-01T00:00:00.000Z", updatedAt: "2026-01-01T00:00:00.000Z", tempoBpm: options.tempoBpm ?? 120, initialKeySignatureId: options.initialKeySignatureId ?? "c-major", initialTimeSignature: options.initialTimeSignature ?? "4/4", measures, ties: options.ties ?? [] });
