...
Ear Training still requires the explicit prompt-play action and never autoplays on configured launch or advancement. These engine contracts add no host presentation, persistence, progress targets, Melody orchestration, or Practice Session runtime.
